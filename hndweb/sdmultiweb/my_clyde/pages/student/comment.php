...
<div class="max-w-2xl my-56 mx-auto">
    <h2>Post a comment</h2>
    <form action="../queries/student_comment.php" method="post">
        ...
        <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
                <label for="editor" class="sr-only">Post a comment</label>
                <textarea id="editor" rows="8" class="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Type a comment" required></textarea>
            </div>
        </div>
        <input type='submit' class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800" value='Post Comment'>
    </form>

	<p class="mt-5">Your comment will be shown when it has been approved.</p>
