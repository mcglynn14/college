...
?>
      ...
      <div class="flex items-center justify-center w-full lg:p-12">
        <div class="flex items-center xl:p-10" action="#">
          <form action="config/authentication.php" method="post" class="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl">
            ...
            <a class="flex items-center justify-center w-full py-4 mb-6 text-sm font-medium transition duration-300 rounded-2xl text-grey-900 bg-grey-300 hover:bg-grey-400 focus:ring-4 focus:ring-grey-300" href="<?= BASE_PATH ?>adminlogin">
            ...
            <div class="flex items-center mb-3">
              ...
              <hr class="h-0 border-b border-solid border-grey-500 grow">
                ...
                <label for="student_num" class="mb-2 text-sm text-start text-grey-900">Student number*</label>
                <input name="student_num" id="text" type="text" placeholder="student num" class="flex items-center w-full px-5 py-4 mr-2 text-sm font-medium outline-none focus:bg-grey-400 mb-7 placeholder:text-grey-700 bg-grey-200 text-dark-grey-900 rounded-2xl"/>
                <label for="password" class="mb-2 text-sm text-start text-grey-900">Password*</label>
                <input name="psw" id="password" type="password" placeholder="Enter a password" class="flex items-center w-full px-5 py-4 mb-5 mr-2 text-sm font-medium outline-none focus:bg-grey-400 placeholder:text-grey-700 bg-grey-200 text-dark-grey-900 rounded-2xl"/>
            ...
            <p class="text-sm leading-relaxed text-grey-900">Not registered yet? <a href="<?= BASE_PATH ?>register" class="font-bold text-grey-700">Create an Account</a></p>
          </form>
        </div>
      </div>
    </div>
