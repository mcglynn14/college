        ...
        <div class="grid grid-cols-1">
          <div class="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-lg">
            <div class="flex flex-col items-center pt-6 pr-6 pb-6 pl-6">
              <img
                  src="<?= ROOT_DIR ?>img/<?= $blogImg ?>" class="flex-shrink-0 object-cover object-center btn- flex w-16 h-16 mr-auto -mb-8 ml-auto rounded-full shadow-xl">
              ...
              <div class="w-full mt-6">
                <button onclick="window.location.href='<?= ROOT_DIR ?>dashboard/admin/config/publishComment.php?cid=<?= $commentID ?>';" class="flex text-center items-center justify-center w-full pt-4 pr-10 pb-4 pl-10 text-base
