...
<!--table of users  -->
  ...
  <div class="container w-full md:w-4/5  mx-auto px-2">
    ...
    <button onclick="window.location.href='../a/addUser';" class="bg-ctc-gold text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150 mb-7" type="button">ADD USER</button>
