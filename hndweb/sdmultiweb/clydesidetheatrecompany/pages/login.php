    ...
    <div class="hidden fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
      ...
      <main>
        <section class="pt-4 mb-40 mt-10">
          ...
          <form action="" class="flex flex-col items-center pb-7">
            <div class="flex px-7 pb-7">
              <p class="text-ctc-black text-body pr-4">Username</p>
              <input type="text" class="py-4 px-4 border border-ctc-black">
            </div>
            <div class="flex px-7 items-center pb-7">
              <p class="text-ctc-black text-body pr-3">Password</p>
              <input type="text" class="py-4 px-4 border border-ctc-black">
            </div>
            <button type="submit" class="bg-ctc-gold py-4 px-4 text-white text-body">Login</button>
          </form>
        </section>
      </main>
